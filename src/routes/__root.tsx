  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">มีบางอย่างผิดพลาด ลองรีเฟรชหรือกลับไปหน้าหลัก</p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-input bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-accent">กลับหน้าหลัก</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "POS สำหรับร้านกาแฟ ใช้ง่ายบนไอโฟน จัดการเมนู เก็บเงิน และดูประวัติการขายในที่เดียว" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=Noto+Sans+Thai:wght@400;500;600;700&display=swap" },
    ],
  }),
